      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-3">
            ...
            <p className="text-sm text-white/80">Discover your next great read with us.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/books" className="hover:text-white/80 transition-colors">Books</a></li>
              <li><a href="/categories" className="hover:text-white/80 transition-colors">Categories</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/shipping" className="hover:text-white/80 transition-colors">Shipping</a></li>
              <li><a href="/returns" className="hover:text-white/80 transition-colors">Returns</a></li>
            </ul>
          </div>
          <div>
            ...
            <form className="space-y-2">
              <input
                ...
                className="w-full px-3 py-2 bg-white/20 rounded-md placeholder-white/70 text-white focus:outline-none focus:ring-2 focus:ring-white"
              />
              <button
                type="submit"
