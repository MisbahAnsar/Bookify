...
const Choice = () => {
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      try {
        const response = await fetch('http://localhost:5000/api/bookchoices');
  ...
  return (
    <div className='w-full py-6'>
      <div className='md:mx-16'>
        <div className='flex'>
        <h1 className='text-3xl font-serif font-bold tracking-tighter lg:mx-14'>Books You Might Like</h1>
